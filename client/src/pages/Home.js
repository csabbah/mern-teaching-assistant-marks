...
const Home = () => {
  ...
  const imageCaptions = [
    ...
    "That time we found a GOOD Italian restaurant called La Vecchia, I remember we spoke about our experience in highschool that night",
    "That time we time traveled to the 80s when you took me out for my first Birthday together",
    "The first time we go to the Storm crow manor, the first time you see my inner nerd too",
    "The day you showed me the 3rd best reason to visit Cambridge, Tito being 2nd, you being 1st😘",
    ...
    "And of course the cute bridge picture, a must add if I must say so myself",
    "The time we discovered mini Europe near Brant Street Pier",
    ...
    "The day your basketball team won the tournament, was I surprised? Nope. They had the best coach :)",
    "The day I met Diana for the first time in person, also the first time we see fireworks together",
    ...
    "Our FIRST Raptors game together, a milestone❤️",
    "The picture we took after the Cambridge mill restaurant, you were cold here, that's why you had my jacket on, I got you :)",
    "The picture I took of you at the restaurant, I remember our conversations about our siblings and what we love about them",
